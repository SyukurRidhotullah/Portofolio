...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('#site-logo-inner').find('img').attr( {src:'assets/images/logo/logo.svg',width:'45',height:'auto'} );

              $('#logo-footer.style').find('img').attr( {src:'assets/images/logo/logo.svg',width:'45',height:'auto'} );
              $('#logo-footer.style2').find('img').attr( {src:'assets/images/logo/logo.svg',width:'45',height:'auto'} );
          }   
        };
    ...
    $(".dark").on('click', function (e) {
        ...
        document.getElementById("logo_footer").src = "assets/images/logo/logo.svg";
    });
